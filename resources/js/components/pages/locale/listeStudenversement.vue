								...
								<tr v-for="(data,  i) in classeListe"  :key="i">
									...
									<td align="center">
                                        ...
                                        <router-link to="detailsEleveFinance">
                                           ...
                                           <button @click="ParentEleve(data,i)" class="btn btn btn-success btn-xs" title="Les details sur cet eleve "><Icon type="md-checkmark-circle-outline" /></button>
