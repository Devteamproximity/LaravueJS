                            ...
                            <div class="col-12">
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        <!-- Nav tabs -->
                                        <ul
                                            class="nav nav-pills justify-content-end mb-20"
                                        >
                                            <li class=" nav-item">
                                                <a
                                                    href="#navpills2-1"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr v-for="(data, i) in messages" :key="i">
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                >
                                                                                                 <span style="font-size:10px;"> Destinataire : </span> {{data.type_destinataire}}
                                                                                                </p>
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            <td
                                                                                                class="mailbox-date"
                                                                                            >
                                                                                                <span class="badge badge-info" > envoyé le  :{{data.messages.date |dateFormat}} </span>
                                                                                            </td>
                                                                                        </tr>
...
export default {
    components: { Header, MenuLocal, Multiselect, Chats },
