			  ...
			  <div class="box box-default">
				<div class="box-header with-border">
				   ...
				   <div class="row">
                        ...
                        <div class="col md-6"> <span style="color:rgb(21, 69, 156)"> Destinataires :</span> <span style="font-weight: bold;"> {{MessageParent.type_destinataire}}</span> </div>

                        <div class="col md-6"> <span style="color:rgb(21, 69, 156)"> Date d'envoi :</span> <span style="font-weight: bold;"> {{MessageParent.messages.date|dateFormatHeure}}</span> </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <h5 style="color:rgb(23, 64, 139)"> Objet : {{MessageParent.messages.object}} </h5> <br>
                             ...
                             <span style="color:rgb(21, 69, 156)"> Expediteur
                                 ...
                                 <br> </span>  <span style="font-weight: bold;">   {{MessageParent.user.nom}}   {{MessageParent.user.prenom}} (Parent) </span>
                             <br>
...
export default {
    ...
    async mounted() {
            ...
            if (localStorage.messageParent) {

                this.MessageParent = JSON.parse(localStorage.getItem("messageDetails"));
