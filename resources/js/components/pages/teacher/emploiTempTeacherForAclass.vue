			  ...
			  <div class="col-12 ">
				<div class="box">
                    ...
                    <div class="box-header bg-primary">
                        <h4 class="box-title" style="margin:auto"><strong> Emploi de temps  de la classe {{EleveClasse.libelleClasse}}
                ...
                <div class="card" style="width:300px;margin:auto" >
				  ...
				  <img  style="height: 400px; width:300px"  class="card-img-top" :src=" `/Photos/Logos/${EleveClasse.emp_Classe}`"  alt="Card image cap">

				  <div class="card-footer justify-content-between d-flex">

					<span class="text-muted">

                        <a  :download="EleveClasse.libelleClasse" :href="`/Photos/Logos/${EleveClasse.emp_Classe}`">
