        ...
        <div class="wrapper">
            ...
            <Modal v-model="PosterModal" width="660">
                <p slot="header" style="text-align:center">
                    <span> Cahier du texte de la semaine </span>
                </p>
                ...
                <div slot="footer">
                    <Button type="primary" size="large" long @click="Poster"
                        >Envoyer</Button
                    >
                </div>
            </Modal>
                    ...
                    <section class="content">
                        ...
                        <div>
                            <Button class="pull-right" type="primary" @click="showPostterModale">
                                <Icon type="md-add" /> Nouveau</Button
                            >
                        </div>
...
export default {
    components: { Header, MenuLocal, Chats, MenuTeacher },
    data() {
        return {
            ClassListes:[],
            CahiersListes:[],
    ...
    methods: {
        ...
        async Poster() {
            ...
            if (response4.status == 200) {
                ...
                this.s("Cahier de texte rempli  correctement");
        ...
        async publier() {
            ...
            if (response.status == 200) {
                this.s("Cahier de texte  publié correctement");
                 this.$router.go()
